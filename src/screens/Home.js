...
export default class HomeScreen extends Component{
    render(){
        return(
            ...
            <Text style={{fontSize:40,fontFamily:'Roboto_Black',color:'#fff'}}>641</Text>
            ...
            >
            <View style={{alignItems:'flex-end'}}>
            <Text style={{fontSize:40,fontFamily:'Roboto_Black',color:'#fff'}}>83</Text>
            ...
            >
            <View style={{alignItems:'flex-end'}}>
            <Text style={{fontSize:40,fontFamily:'Roboto_Black',color:'#fff'}}>8</Text>
            ...
            <Text style={{fontFamily:'Roboto_Black',fontSize:18}}>Ghana's Situation Updates</Text>
            <Text style={{fontFamily:'Roboto',fontSize:12}}>Last Updated:4/16/2020</Text>
            </View>
            <View style={{flex:1,marginHorizontal:45,marginTop:35}}>
            <View style={{marginBottom:70}}>
            <Text style={{fontFamily:'Roboto_Black'}}>{DATA[0].title}</Text>
            <Text style={{fontFamily:'Roboto',fontSize:14,marginTop:18}}>{DATA[0].data}</Text>
            </View>
            <View style={{marginBottom:70}}>
            <Text style={{fontFamily:'Roboto_Black'}}>{DATA[0].title}</Text>
            <Text style={{fontFamily:'Roboto',fontSize:14,marginTop:18}}>{DATA[0].data}</Text>
